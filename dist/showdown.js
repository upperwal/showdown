;/*! showdown v 2.0.0-alpha1 - 11-06-2018 */
(function(){
/**
...
showdown.subParser('makehtml.images', function (text, options, globals) {
  ...
  function writeImageTag (wholeMatch, altText, linkId, url, width, height, m5, title) {
    ...
    url = url.replace(showdown.helper.regexes.asteriskDashAndColon, showdown.helper.escapeCharactersCallback);
    var result = '</p><img src="' + url + '" alt="' + altText + '" class="' + altText + '"';
...
/**
 * This will emit <span class="highlight-text"></span>
 */
showdown.subParser('makehtml.textHighlighter', function (text, options, globals) {
  'use strict';

  function parseInside (txt) {
    return '<span class="highlight-text">' + txt + '</span>';
  }

  text = globals.converter._dispatch('makehtml.textHighlighter.before', text, options, globals);

  text = text.replace(/(?:\[){2}([\s\S]+?)(?:\]){2}/g, function (wm, txt) { return parseInside(txt); });

  text = globals.converter._dispatch('makehtml.textHighlighter.after', text, options, globals);
...
showdown.Converter = function (converterOptions) {
  ...
  this.makeHtml = function (text) {
    ...
    text = showdown.subParser('makehtml.textHighlighter')(text, options, globals);
